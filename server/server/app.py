...
=======
    CORS(app, origins=["http://localhost:5173", "http://localhost:5174", "https://weiiitt.github.io"], supports_credentials=True)  # Allow frontend origins
>>>>>>> 06611cc (changed endpoint from ngrok to localxpose)
